...
@section('content')
{{-- Content Goes Here --}}
<form action="{{route('object.update')}}" method="POST">
    @csrf
                                    ...
                                    <div class="kt-section__body">
                                        ...
                                        <div class="form-group row">
                                                    ...
                                                    <select class="form-control col-6" name="reseller_id">
                                                        ...
                                                        @foreach ($resellers as $reseller)
                                                            <option value="{{$reseller->id}}"
                                                                {{($data->reseller->id == $reseller->id ? "selected='selected'" : "")}}
                                                    ...
                                                    <select class="form-control col-6" type="text" name="company_id">
                                                        ...
                                                        @foreach ($companies as $company)
                                                            <option value="{{$company->id}}"
                                                                {{($data->company->id == $company->id ? "selected='selected'" : "")}}
                                                                >{{$company->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                        ...
                                                        <select class="form-control col-6" type="text" name="company_branch_id">
                                                            ...
                                                            @foreach ($branches as $branch)
                                                                <option value="{{$branch->id}}"
                                                                    {{($data->branch->id == $branch->id ? "selected='selected'" : "")}}
                                                                    >{{$branch->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <input class="form-control col-6" type="text" name="object_name" placeholder="Enter Object Name" value="{{$data->name}}" />
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-xl-3 col-lg-3 col-form-label">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <select class="form-control col-6" name="device_type">
                                                        ...
                                                        <option value="3">IAC 140 IR</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <input class="form-control col-6" type="number" name="imei_number" placeholder="Enter device imei number.."  value="{{$data->device_master->imei}}" />
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-xl-3 col-lg-3 col-form-label">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <input class="form-control col-6" type="text" name="sim_number" placeholder="SIM number.." value="{{$data->device_master->sim_number}}" />
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-xl-3 col-lg-3 col-form-label">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <select class="form-control col-6" name="device_timezone">
                                                        ...
                                                        @foreach ($timezone as $timezoneItem)
                                                            <option value="{{$timezoneItem->id}}" {{($data->device_timezone == $timezoneItem->id ? "selected='selected'" : "")}}>{{$timezoneItem->type}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <select class="form-control col-6" name="speed_detection">
                                                        <option selected>From Device</option>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <input class="form-control col-6" type="text" name="odometer" placeholder="Odometer.." value="{{$data->odometer}}"/>
                                                </div>
                                            </div>
                                            <div class="form-group row d-none">
                                                <label class="col-xl-3 col-lg-3 col-form-label">
                                ...
                                <div class="kt-section kt-section--first">
                                    ...
                                    <div class="kt-section__body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <input class="form-control col-6" type="text" name="plate_number" placeholder="Enter plate number.." value="{{$data->plate_number}}" />
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                ...
                                                <div class="row kt-radio-inline">
                                                    <label class="kt-radio p-3">
                                                        <input class="p-3" type="radio" name="object_type" value="Ambulance" {{($data->object_type == "Ambulance" ? "checked" : "")}}>
                                                        <img class="img" src="{{asset('img/objects/Ambulance.png')}}" alt="Ambulance" width="40" height="40">
                                                            <span></span>
                                                    </label>
                                                    <label class="kt-radio p-3">
                                                        <input class="p-3" type="radio" name="object_type" value="Barge" {{($data->object_type == "Barge" ? "checked" : "")}}>
                                                        <img class="img" src="{{asset('img/objects/Barge.png')}}" alt="Barge" width="40" height="40">
                                                            <span></span>
                                                    </label>
                                                    <label class="kt-radio p-3">
                                                        <input class="p-3" type="radio" name="object_type" value="Bike" {{($data->object_type == "Bike" ? "checked" : "")}}>
                                                        <img class="img" src="{{asset('img/objects/Bike.png')}}" alt="Bike" width="40" height="40">
                                                            <span></span>
                                                    </label>
                                                    <label class="kt-radio p-3">
                                                        <input class="p-3" type="radio" name="object_type" value="Bus" {{($data->object_type == "Bus" ? "checked" : "")}}>
                                                        <img class="img" src="{{asset('img/objects/Bus.png')}}" alt="Bus" width="40" height="40">
                                                            <span></span>
                                                    </label>
                                                    <label class="kt-radio p-3">
                                                        <input class="p-3" type="radio" name="object_type" value="Car" {{($data->object_type == "Car" ? "checked" : "")}}>
                                                        <img class="img" src="{{asset('img/objects/Car.png')}}" alt="Car" width="40" height="40">
                                                            <span></span>
                                                    </label>
                                                    <label class="kt-radio p-3">
                                                        <input class="p-3" type="radio" name="object_type" value="Default" {{($data->object_type == "Default" ? "checked" : "")}}>
                                                        <img class="img" src="{{asset('img/objects/Default.png')}}" alt="Default" width="40" height="40">
                                                            <span></span>
                                                    </label>
                                                    <label class="kt-radio p-3">
                                                        <input class="p-3" type="radio" name="object_type" value="JCB" {{($data->object_type == "JCB" ? "checked" : "")}}>
                                                        <img class="img" src="{{asset('img/objects/JCB.png')}}" alt="JCB" width="40" height="40">
                                                            <span></span>
                                                    </label>
                                                    <label class="kt-radio p-3">
                                                        <input class="p-3" type="radio" name="object_type" value="PersonalTracker" {{($data->object_type == "PersonalTracker" ? "checked" : "")}}>
                                                        <img class="img" src="{{asset('img/objects/PersonalTracker.png')}}" alt="PersonalTracker" width="40" height="40">
                                                            <span></span>
                                                    </label>
                                                    <label class="kt-radio p-3">
                                                        <input class="p-3" type="radio" name="object_type" value="PoliceCar" {{($data->object_type == "PoliceCar" ? "checked" : "")}}>
                                                        <img class="img" src="{{asset('img/objects/PoliceCar.png')}}" alt="PoliceCar" width="40" height="40">
                                                            <span></span>
                                                    </label>
                                                    <label class="kt-radio p-3">
                                                        <input class="p-3" type="radio" name="object_type" value="Rickshaw" {{($data->object_type == "Rickshaw" ? "checked" : "")}}>
                                                        <img class="img" src="{{asset('img/objects/Rickshaw.png')}}" alt="Rickshaw" width="40" height="40">
                                                            <span></span>
                                                    </label>
                                                    <label class="kt-radio p-3">
                                                        <input class="p-3" type="radio" name="object_type" value="SchoolBus" {{($data->object_type == "SchoolBus" ? "checked" : "")}}>
                                                        <img class="img" src="{{asset('img/objects/SchoolBus.png')}}" alt="SchoolBus" width="40" height="40">
                                                            <span></span>
                                                    </label>
                                                    <label class="kt-radio p-3">
                                                        <input class="p-3" type="radio" name="object_type" value="Taxi" {{($data->object_type == "Taxi" ? "checked" : "")}}>
                                                        <img class="img" src="{{asset('img/objects/Taxi.png')}}" alt="Taxi" width="40" height="40">
                                                            <span></span>
                                                    </label>
                                                    <label class="kt-radio p-3">
                                                        <input class="p-3" type="radio" name="object_type" value="Tempo" {{($data->object_type == "Tempo" ? "checked" : "")}}>
                                                        <img class="img" src="{{asset('img/objects/Tempo.png')}}" alt="Tempo" width="40" height="40">
                                                            <span></span>
                                                    </label>
                                                    <label class="kt-radio p-3">
                                                        <input class="p-3" type="radio" name="object_type" value="TractorUnit" {{($data->object_type == "TractorUnit" ? "checked" : "")}}>
                                                        <img class="img" src="{{asset('img/objects/TractorUnit.png')}}" alt="TractorUnit" width="40" height="40">
                                                            <span></span>
                                                    </label>
                                                    <label class="kt-radio p-3">
                                                        <input class="p-3" type="radio" name="object_type" value="Truck" {{($data->object_type == "Truck" ? "checked" : "")}}>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <input class="form-control col-6" autocomplete="off" id="kt_datepicker_1" type="text" name="mfg_date" placeholder="Enter Manufacture Date.." value="{{date("m/d/Y", strtotime($data->manufacture_date))}}" />
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <input class="form-control col-6"  autocomplete="off" id="kt_datepicker_1" type="text" name="purchage_date" placeholder="Enter Purchage Date" value="{{date("m/d/Y", strtotime($data->purchase_date))}}" />
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <input class="form-control col-6"  autocomplete="off" id="kt_datepicker_1" type="text" name="installation_date" placeholder="Enter Installation Date.."  value="{{date("m/d/Y", strtotime($data->installation_date))}}" />
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <input class="form-control col-6" type="text" name="registration_number" placeholder="Registration Number.." value="{{$data->device_master->registration_number}}" />
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">
