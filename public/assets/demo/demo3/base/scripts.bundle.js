      ...
      function a() {
        ...
        (n =
          e.height instanceof Function
            ...
            : parseInt(e.height)),
          e.disableForMobile && KTUtil.isInResponsiveRange("tablet-and-mobile")
      ...
      if (0 !== t(this).length) {
        ...
        var l = {
                  ...
                  if (void 0 !== r)
                    if ("auto" === r) {
                      ...
                      if (o[s]) l = o[s];
                        ...
                        var d = t(i.tableBody).find(
                          '.kt-datatable__cell[data-field="' + s + '"]'
                        );
                        l = o[s] = Math.max.apply(
                          null,
                          t(d)
                            .map(function() {
          ...
          columnHide: function() {
            ...
            t.each(o.columns, function(n, o) {
              if (void 0 !== o.responsive) {
                var l = o.field,
                  r = t.grep(t(i.table).find(".kt-datatable__cell"), function(
                    e,
                    a
                  ) {
          ...
          hideColumn: function(e) {
            ...
            var a = t.grep(t(i.table).find(".kt-datatable__cell"), function(
              a,
              n
            ) {
            ...
            if (t(l.recentNode.length)) {
              ...
              e
                ? (l.recentNode === l.nodeCols &&
                    delete o.columns[n].responsive,
                  t(l.recentNode).show())
                : (l.recentNode === l.nodeCols &&
                    l.setOption("columns." + n + ".responsive", {
                      hidden: "xl"
                    }),
                  t(l.recentNode).hide()),
                l.redraw();
        ...
        r = {
          ...
          getSubmenuMode: function(t) {
            return KTUtil.isInResponsiveRange("desktop")
              ? t && KTUtil.hasAttr(t, "data-ktmenu-submenu-toggle")
          ...
          resetActiveItem: function(t) {
            for (
              ...
              for (
                var s = 0,
                  d = (n = KTUtil.parents(r, ".kt-menu__item--submenu")).length;
                s < d;
                s++
              ) {
                var c = n[i];
