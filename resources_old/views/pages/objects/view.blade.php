    ...
    <div class="kt-portlet__head kt-portlet__head--lg">
        ...
        <div class="kt-portlet__head-toolbar">
            <div class="kt-portlet__head-wrapper">
                ...
                <a class="btn btn-brand btn-icon-sm" href="{{route('object.assign.view')}}">
                    <i class="la la-sitemap"></i> Assign Vehicles
                </a>
                <a class="btn btn-brand btn-icon-sm" href="{{route('object.bulk.view')}}">
                    <i class="flaticon-upload"></i> Bulk Upload
                </a>
                @endif
