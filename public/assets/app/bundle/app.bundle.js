        ...
        (function() {
          ...
          KTUtil.scrollInit(n, {
            ...
            height: function() {
              ...
              return (
                t &&
                  ((n -= parseInt(KTUtil.actualHeight(t))),
                  (n -= parseInt(KTUtil.css(t, "marginBottom")))),
...
var KTQuickSearch = function() {
    var t,
      ...
      u = function() {
        (f = !1),
          KTUtil.removeClass(s, _),
          i && (n.value.length < 2 ? KTUtil.hide(i) : KTUtil.show(i, "flex"));
      },
      p = function() {
        l &&
      ...
      K = function() {
        if (c && r === n.value)
          return u(), KTUtil.addClass(t, T), p(), void KTUtil.scrollUpdate(a);
        (r = n.value),
