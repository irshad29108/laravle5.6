    ...
    (t = $(".kt-datatable").KTDatatable({
      data: {
        ...
        source: {
          read: {
            url:
              "https://keenthemes.com/metronic/themes/themes/metronic/dist/preview/inc/api/datatables/demos/customers.php"
          }
        },
        pageSize: 10,
        serverPaging: !0,
      ...
      detail: {
        ...
        content: function(t) {
          $("<div/>")
            .attr("id", "child_data_ajax_" + t.data.RecordID)
            .appendTo(t.detailCell)
            .KTDatatable({
              data: {
                type: "remote",
                source: {
                  read: {
                    url:
                      "https://keenthemes.com/metronic/themes/themes/metronic/dist/preview/inc/api/datatables/demos/orders.php",
                    params: {
                      query: { generalSearch: "", CustomerID: t.data.RecordID }
                    }
                  }
                },
                pageSize: 10,
              ...
              columns: [
                { field: "RecordID", title: "#", sortable: !1, width: 30 },
                {
                  ...
                  template: function(t) {
                    return (
                      "<span>" + t.OrderID + " - " + t.ShipCountry + "</span>"
                    );
                  }
                },
