...
{
    private $tripURI = 'http://trackpro.indianautocompany.in:3000/api/trip-report-current';
    private $tripFilteredURI = 'http://trackpro.indianautocompany.in:3000/api/trip-report';
    /**
     * TRIP REPORT CURRENT
     */
