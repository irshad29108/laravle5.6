...
<div class="kt-portlet kt-portlet--mobile" style="margin-top: -4rem;">
    <form method="POST" action="{{route('objects.assign.save')}}">
    @csrf
    ...
    <div class="kt-portlet__head kt-portlet__head--lg">
        ...
        <div class="kt-portlet__head-toolbar">
            <div class="kt-portlet__head-wrapper">
                <a href="{{route('object.assign.view')}}" class="btn btn-clean btn-icon-sm">
    ...
    <div class="kt-portlet__body">
        ...
        @foreach ($objects->pluck('id') as $vehicleID)
        <input type="hidden" name="vehicles[]" value="{{$vehicleID}}">
        @endforeach
        <!--begin: Datatable -->
