                                    ...
                                    yAxes: [
                                        {
                                            ...
                                            gridLines: {
                                                ...
                                                borderDash: [3, 4],
                                                zeroLineWidth: 1,
                                                zeroLineColor: KTApp.getBaseColor(
                                                    "shape",
                                                    2
                                                ),
...
jQuery(document).ready(function() {
    ...
    $('div[data-ktwizard-type="action-next"]').click(function() {
        var tabs = $(".kt-portlet--tabs li.nav-item");
        var activeLi = tabs.find("a.active").parent("li");
        activeLi
            .next("li")
            .find("a")
            .trigger("click");
        var itemsLength = tabs.length;
        if (itemsLength == tabs.index(tabs.find("a.active")) + 1) {
            // $('div[data-ktwizard-type="action-next"]').add(
            //     "disabled",
            //     "disabled"
            // );
        }
    });
    $('div[data-ktwizard-type="action-prev"]').click(function() {
        var tabs = $(".kt-portlet--tabs li.nav-item");
        var activeLi = tabs.find("a.active").parent("li");
        activeLi
            .prev("li")
