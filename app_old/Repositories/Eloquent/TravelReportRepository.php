...
{
    private $travelURI = 'http://trackpro.indianautocompany.in:3000/api/report-current';
    private $travelFilteredURI = 'http://trackpro.indianautocompany.in:3000/api/report';
    /**
     * TRIP REPORT CURRENT
     */
