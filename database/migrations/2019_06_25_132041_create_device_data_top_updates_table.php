...
class CreateDevicedataTopUpdatesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('device_data_top_updates', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('device_data_top_updates');
    }
}
