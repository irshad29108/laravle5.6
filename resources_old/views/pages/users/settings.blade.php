...
<form action="{{route('add-user.create')}}" method="POST">
    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">USER SETTINGS &nbsp;<i class="flaticon2-settings fa fa-spin"></i></h3>
                                ...
                                <div class="kt-section kt-section--first">
                                    <div class="kt-section__body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <select class="form-control col-6 multiselect" name="alerts" multiple="multiple" placeholder="Select alerts..">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <select class="form-control multiselect col-6" class="gps" name="gps" multiple="multiple" placeholder="Select gps device..">
                                                    <option>IAC 101</option>
                                                    <option>IAC 140</option>
                                                    <option>IAC 140 CAN</option>
                                                    <option>IAC 102</option>
                                                    <option>IAC 104</option>
                                                    <option>IAC 103</option>
                                                    <option>IAC 105</option>
                                                    <option>IAC 106</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <select class="form-control col-6" name="default_language">
                                ...
                                <div class="kt-section kt-section--first">
                                    <div class="kt-section__body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <input class="form-control col-6" type="password" name="email_password" placeholder="******" />
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label">
